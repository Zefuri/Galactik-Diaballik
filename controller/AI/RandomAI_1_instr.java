...
*		else
*			System.out.println("Je me deplace, il me reste "+moves+ "deplacements");
*/
...
//					System.out.println("OutTimeAppel "+random1+" C'est "+ball+" qui a la balle, il peut passer: "+canPass(equip[ball],equip[random1])+" On peut en faire: "+passNumber());
...
//				System.out.println("Direction Change");
			...
			if(random1==0)
				System.out.println("-Je saute mon tour");
/**			else if(random1==1)
*				System.out.println("Je passe, il me reste "+passes+" passe");
*			else
*				System.out.println("Je me deplace, il me reste "+moves+" deplacements");
*/
		}
